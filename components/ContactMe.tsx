...
export default function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {window.location.href = `mailto:arafatulla121@gmail.com?subject=${formData.subject}&body=Hi, I'm ${formData.name}. ${formData.message} (${formData.email})`};
  return (
    <motion.div
      initial={{ opacity: 0 }}
